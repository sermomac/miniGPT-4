...
class RunnerBase:
    ...
    def dataloaders(self) -> dict:
        ...
        if self._dataloaders is None:
            ...
            self._dataloaders = {k: v for k,
                                 v in zip(split_names, dataloaders)}
    ...
    def create_loaders(
        ...
        def _create_loader(dataset, num_workers, bsz, is_train, collate_fn):
            ...
            if isinstance(dataset, ChainDataset) or isinstance(
                ...
                if is_train:
                    loader = IterLoader(
                        loader, use_distributed=self.use_distributed)
        ...
        for dataset, bsz, is_train, collate_fn in zip(
            ...
            if isinstance(dataset, list) or isinstance(dataset, tuple):
                ...
                loader = MultiIterLoader(
                    loaders=[
                        _create_loader(d, num_workers, bsz,
                                       is_train, collate_fn[i])
    ...
    def _load_checkpoint(self, url_or_filename):
        ...
        self.unwrap_dist_model(self.model).load_state_dict(
